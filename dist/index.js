...
function expectTemplateVar(value, name) {
    if (typeof value === "string")
        return value;
...
server.registerResource("artifact", new ResourceTemplate("artifact://sha256/{hash}", { list: undefined }), { title: "RWM Artifact", description: "Content-addressed artifact" }, async (uri, { hash }) => {
...
server.registerResource("workspace-file", new ResourceTemplate("workspace://{path}", { list: undefined }), { title: "Workspace File", description: "Read-only file under workspace root" }, async (uri, { path }) => {
